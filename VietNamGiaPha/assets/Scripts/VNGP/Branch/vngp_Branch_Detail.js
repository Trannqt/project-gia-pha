...
//        startPage: 1,
//    };
//    $('.paginationBranchSource').twbsPagination(configs);
...
//            $('.paginationBranchSource').twbsPagination('destroy');

//            $('.paginationBranchSource').twbsPagination($.extend({}, configs, {
...
//                        if (ele.Sex == 'Nữ') tmpImageg = 'woman.png';
//                        else tmpImage = 'man.png';
                        
//                        ele.img = `/upload/branchsource/${tmpImage}`;
