        ...
        for (var i = 0; i < result.length; i++) {
            content += `
                <div class="row col-md-12">
                    ...
                    <div class="col-md-9">
                        <h2 style="color: white !important;"><a style="cursor:pointer !important;color:#e4ee4c !important;" href="/RootPost/RootPostView/${result[i].RootPostId}">${result[i].Title}</a></h2>
...
$(document).ready(function () {
    ...
    if (result) {
        ...
        var iframe = `<iframe id="reason_linkyoutube" width="560" height="315" src="${url}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                   `;
        var img = `/assets/upload/reasonExists/${result[0].ImageThumbnail}`;
    ...
    var paramsFirstLoadPostList = {
        ...
        pageSkip: -1,
        txtSearch: "",
        type: CommonParams.POST_TYPE.LICH_SU_TOC_HO
    };
